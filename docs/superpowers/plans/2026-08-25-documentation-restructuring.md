...
- [x] **Step 1: Write `docs/architecture/overview.md`**
...
- [x] **Step 1: Write Core Architecture Spec (`2026-04-05-core-architecture-design.md`)**
  - Cover PRs #41–#44: Workspace scaffold, `SilvestreImage`, I/O, `Filter` trait & convolution.
- [x] **Step 2: Write Filters, Effects & Transforms Spec (`2026-04-10-filters-effects-transforms-design.md`)**
  - Cover PRs #45–#54, #56, #58: Spatial filters, edge detectors, color adjustments, resize, mirror, crop, histogram analysis.
- [x] **Step 3: Write CLI & Interactive TUI Spec (`2026-04-29-cli-interactive-tui-design.md`)**
  - Cover PRs #57, #62: Ratatui TUI, live image preview, filter parameter modals, pipeline runner.
- [x] **Step 4: Write C FFI Layer Spec (`2026-04-29-c-ffi-layer-design.md`)**
  - Cover PR #59: C ABI, opaque handles, `cbindgen` header generation, error strings.
- [x] **Step 5: Write WebAssembly Spec (`2026-04-30-wasm-web-demo-design.md`)**
  - Cover PR #60: `silvestre-wasm`, `wasm-bindgen`, raw pixel buffers, web demo.
- [x] **Step 6: Write Flutter Plugin Spec (`2026-04-30-flutter-plugin-and-app-design.md`)**
  - Cover PRs #61, #63: `silvestre_flutter`, `flutter_rust_bridge`, BLoC pattern, camera & before/after slider.
- [x] **Step 7: Write CI & Release Spec (`2026-05-01-ci-and-release-design.md`)**
...
- [x] **Step 1: Update repository structure diagram in `README.md`**
- [x] **Step 2: Add Documentation & Superpowers Index to `README.md`**
...
- [x] **Step 1: Run workspace verification**
  ...
  - Expected: PASS
- [x] **Step 2: Check git status and branch diff**
  - Run: `git status`
